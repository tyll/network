            ...
            for r in ip["route"]:
                ...
                if connection["interface_name"]:
                    ...
                    warn_fcn(
                        ...
                        "Therefore, the route '{1}' will be configured without the "
                        "output device and the kernel will choose it automatically "
                        "which might result in an unwanted device being used. To avoid "
                        "this, specify `interface_name` in the connection "
                        "appropriately.".format(connection["name"], r),
                    )
                if r["metric"] != -1:
